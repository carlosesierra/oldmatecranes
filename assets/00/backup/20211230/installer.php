...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211230_oldmatecranesrigging_0db4ae360cbc34434931_20211230064752_archive.zip';
	const ARCHIVE_SIZE		 = '28601874';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0db4ae3-30064752';
    const SECONDARY_PACKAGE_HASH = 'b89c021-30064752';
	const VERSION			 = '1.4.3';
